...
from src.utils.base_layers import ConvModule
from src.utils.utils_models import resize
from src.models.decoders.ppm import PPM
...
class UPerHead(nn.Module, metaclass=ABCMeta):
    ...
    def forward(self, inputs):
        ...
        cls_sits_feats = self.cls_seg(output)
        ...
        return output, cls_sits_feats, multi_lvls_cls
