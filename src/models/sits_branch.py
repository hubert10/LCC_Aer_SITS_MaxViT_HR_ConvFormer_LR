...
from src.models.decoders.uper_head import UPerHead
from src.models.encoders.conv_transformer import ConvFormerSits
...
class SITSSegmenter(nn.Module):
    ...
    def forward(self, x, batch_positions=None):
        ...
        sits_logits, cls_sits_feats, multi_lvls_cls, = self.decode_head(x_enc)  
