...
- ```
python main.py --config_file=./configs/train
  ```
...
scp -r nhgnkany@transfer.cluster.uni-hannover.de:/bigwork/nhgnkany/Results/MISR_S2/results/checkpoints/misr/srdiff_highresnet_ltae_ckpt/results_0_/HR D:\kanyamahanga\Datasets\MISR_S2